...
model_path = "C:/Users/HP/TAM/Twitter-Sentiment-Analysis/models_final/roberta_2160_swapped"  # CHANGE THIS
tokenizer = RobertaTokenizer.from_pretrained(model_path)
model = RobertaForSequenceClassification.from_pretrained(model_path)


print("=== Load test data ===")
test_data = pd.read_csv("C:/Users/HP/TAM/Twitter-Sentiment-Analysis/data_final/split_2160_test_swapped.csv")  # expects 'text' and 'label' columns
