print("=== Evaluate ===")print("=== Load fine-tuned BERT model ===")import pandas as pd
import torch
...
print("=== Load fine-tuned BERT model ===")
model_path = "C:/Users/HP/TAM/Twitter-Sentiment-Analysis/Twitter-Sentiment-Analysis/bert_normal"  
tokenizer = BertTokenizer.from_pretrained(model_path)
model = BertForSequenceClassification.from_pretrained(model_path)

print("=== Load test data ===")
test_data = pd.read_csv("C:/Users/HP/TAM/Twitter-Sentiment-Analysis/data_final/split_8320_test_normal.csv")  
