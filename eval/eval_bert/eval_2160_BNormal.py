...
model_path = "C:/Users/HP/TAM/Twitter-Sentiment-Analysis/models_final/bert_2160_normal" 
tokenizer = BertTokenizer.from_pretrained(model_path)
model = BertForSequenceClassification.from_pretrained(model_path)


print("=== Load test data ===")
test_data = pd.read_csv("C:/Users/HP/TAM/Twitter-Sentiment-Analysis/data_final/split_2160_test_normal.csv")
