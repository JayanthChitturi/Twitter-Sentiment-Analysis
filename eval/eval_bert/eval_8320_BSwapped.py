...
model_path = "C:/Users/HP/TAM/Twitter-Sentiment-Analysis/Twitter-Sentiment-Analysis/bert_swapped"  # CHANGE THIS
tokenizer = BertTokenizer.from_pretrained(model_path)
model = BertForSequenceClassification.from_pretrained(model_path)

# === Load test data ===
test_data = pd.read_csv("C:/Users/HP/TAM/Twitter-Sentiment-Analysis/data_final/split_8320_test_swapped.csv")  # expects 'text' and 'label' columns
