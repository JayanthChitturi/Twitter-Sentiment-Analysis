...
for model_type, model_name in models:
    for label_type in ["normal", "swapped"]:
        train_file = f"{data_dir}split_2160_train_{label_type}.csv"
        dev_file = f"{data_dir}split_2160_dev_normal.csv"  # Use normal for validation
        output_dir = f"{model_dir}{model_type}_2160_{label_type}"
